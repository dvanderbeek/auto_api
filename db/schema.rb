...
ActiveRecord::Schema[7.1].define(version: 2024_09_19_124615) do
  ...
  create_table "pricing_fee_splits", force: :cascade do |t|
    t.decimal "percentage"
    t.string "payout_wallet_address"
    t.bigint "agreement_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["agreement_id"], name: "index_pricing_fee_splits_on_agreement_id"
  end
  ...
  add_foreign_key "pricing_fee_splits", "pricing_agreements", column: "agreement_id", on_delete: :cascade
end
